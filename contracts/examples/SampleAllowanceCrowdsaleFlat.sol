 ...
 * This file is designed to be used with Remix and MetaMask to create a crowdsale for a date range.
 * It will pay out tokens as ethereum is received.
 ...
 * On the Run tab change the AllowanceCrowdsale drop down and choose SampleCrowdsale
 ...
 * openingTime = Crowdsale opening time in unix epoch seconds eg 1543894840 https://www.epochconverter.com/
 ...
 * Click on the contract link in the To line eg 0xa6bb4b697be69aeca0d0d3ccb47f1e7ccf2b63e9
 * Click on the Code tab and open the Publish link.
 * Enter SampleCrowdsale into the contract
 ...
 * To give the approval you need to call the approve method of the token contract.
 * You can do this in Remix in the Deployed Contracts section if you can see your token contract there.
 * If Remix is not showing then open Etherscan to the contract address and open the Write Contract tab.
 * Click Connect with Metamask
 * Find approve method
 * Enter the crowdsale contract address in quotes eg "0xa6bb4b697be69aeca0d0d3ccb47f1e7ccf2b63e9"
 * Enter the number of tokens to allocate to the crowdsale contract
 * Click Write then Approve in Metamask.
 */
